...
function alterText() {
	...
	document.getElementById("thanks").innerHTML = newText;
}

function returnText() {
	document.getElementById("thanks").innerHTML = originalTitle;
}
